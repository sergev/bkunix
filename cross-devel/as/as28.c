...
int *pass2_reltp2(struct pass2 *p2) { (void)p2; return reltp2; }
int *pass2_reltm2(struct pass2 *p2) { (void)p2; return reltm2; }
int *pass2_relte2(struct pass2 *p2) { (void)p2; return relte2; }
